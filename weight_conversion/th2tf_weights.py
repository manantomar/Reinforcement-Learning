...
from th_pre_model import theano_model
from tf_pre_model import tensorflow_model
...
th_dim_model = theano_model() # Create your theano model here with TH dim ordering

K.set_image_dim_ordering('tf')
tf_dim_model = tensorflow_model() # Create your tensorflow model with TF dimordering here

model_weights = ['theano_weights.h5f'] # Add names of theano model weight file paths here.
