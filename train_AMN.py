...
def get_AMN_policy(s_t):

    q_vals = net.build_net.eval(feed_dict = {state : s_t})
...
def rollout(state, action, encode):
    ...
    while np.max(num_episodes) < MAX_EPISODES:
        ...
        for t in range(10000):
            ...
            q_val_AMN = get_AMN_policy(s_t[game_id])
            ...
            if train == True:
                ...
                # minibatch update
                net.train_step(true_action, state_batch, AMN_action_batch)
